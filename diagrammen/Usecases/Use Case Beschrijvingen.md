...
| Pre-conditie |  |
| Beschrijving | 1. Gameleader start een SoftAP op.<br> 2. Gameleader start een HTTP server.<br> 3. Server laat html form voor gamedata zien. <br> 4. Server slaat html form data op wanneer submit knop is ingedrukt. <br> 5. Gameleader ontvangt spelerdata van speler. <br> 6. Gameleader wacht tot alle spelers ready zijn.<br> 7. Gameleader verstuurt ready signaal.<br> |
