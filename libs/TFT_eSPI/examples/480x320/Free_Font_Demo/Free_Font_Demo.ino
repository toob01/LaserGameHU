...
void loop() {
  ...
  tft.println("Serif Bold 9pt with prln");  // Print the font name onto the TFT screen

  tft.setFreeFont(FSB12);       // Select Free Serif 12 point font
  tft.println();                // Move cursor down a line
  tft.setTextWrap(true);
  tft.print("Serif Bold 12pt with wrap around x bla die bla"); // Print the font name onto the TFT screen
  ...
  tft.drawString("Serif Bold 9pt ha\n/nnextline", xpos, ypos, GFXFF);  // Draw the text string in the selected GFX free font
