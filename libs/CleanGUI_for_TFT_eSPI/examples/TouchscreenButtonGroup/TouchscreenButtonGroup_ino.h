...
#include "crt_TestTouchscreenButtonGroup.h"
namespace crt
{
	MainInits mainInits;            // Initialize CleanRTOS.
}

crt::TestTouchscreenButtonGroup testTouchscreenButtonGroup("TestTouchscreenButtonGroup", 2 /*priority*/, ARDUINO_RUNNING_CORE);
