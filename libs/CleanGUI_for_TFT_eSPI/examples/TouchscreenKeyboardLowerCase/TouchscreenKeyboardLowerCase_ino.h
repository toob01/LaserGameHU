...
#include "crt_TestTouchscreenKeyboardLowerCase.h"
namespace crt
{
	MainInits mainInits;            // Initialize CleanRTOS.
	TestTouchscreenKeyboardLowerCase testTouchscreenKeyboardLowerCase("TestTouchscreenKeyboardLowerCase", 2 /*priority*/, ARDUINO_RUNNING_CORE);
}
